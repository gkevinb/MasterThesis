...
basicEvent1 = Event('Basic Event 1', rel_weibull_dist, main_weibull_dist, parent=vote2)
basicEvent2 = Event('Basic Event 2', rel_weibull_dist, main_weibull_dist, parent=vote2)
intermediateEvent3 = Event('Intermediate Event 3', parent=vote2)
and2 = Gate('AND', parent=intermediateEvent3)
basicEvent3 = Event('Basic Event 3', rel_weibull_dist, main_weibull_dist, parent=and2)
...
basicEvent7 = Event('Basic Event 7', rel_weibull_dist, main_weibull_dist,  parent=and3)
basicEvent8 = Event('Basic Event 8', rel_weibull_dist, main_weibull_dist,  parent=and3)
