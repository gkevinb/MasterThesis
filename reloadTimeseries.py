...
fault_tree.load_time_series_into_basic_events(time_series.time_series)
fault_tree.print_tree()
fault_tree.calculate_time_series()
fault_tree.print_tree()

# Check if recalculated top event time series are the same as the top event times eries in the exported file.
print(fault_tree.top_event.time_series == time_series.time_series[0])
