...
def D():
    ...
    basicEvent2 = Event('Basic Event 2', ['EXP', 1 / 10], weibull_dist, parent=vote2)
...
def F():
    ...
    basic_event_2 = Event("Basic Event 2", ['EXP', 1 / 3], norm_dist, parent=or3)
...
def H():
    ...
    basic_event_2 = Event("Basic Event 2", ['EXP', 1 / 10], norm_dist, parent=and2)
    or3 = Gate("OR", parent=intermediate_event_2)
