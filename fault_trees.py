...
def A():
    ...
    basic_event_3 = Event("Basic Event 3", weibull_dist, main_exp_dist, parent=voting2)
    ...
    basic_event_1 = Event("Basic Event 1", weibull_dist, main_exp_dist, parent=or3)
    basic_event_2 = Event("Basic Event 2", rel_exp_dist, lognorm_dist, parent=or3)
...
def C():
    ...
    basicEvent5 = Event('Basic Event 5', ['EXP', 1 / 10], main_exp_dist, parent=or1)
